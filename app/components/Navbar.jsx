  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center 
        justify-between z-50 ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm dark:bg-[#11001F] dark:shadow-white/20" : ""}`}>
        ...
        rounded-full px-12 py-3 ${isScroll ? "" : "shadow-sm bg-white/50 dark:border dark:border-white/50 dark:bg-transparent"} `}>
        ...
        top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-[#2a004a]
        dark:text-white'>
