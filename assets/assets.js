...
export const workData = [
    {
        ...
        description: 'Simple grievance managing web-site for students and teachers.',
        bgImage: '/work-1.png',
    },
    {
        title: 'Mobile Application',
        description: 'AI powered mobile app for smart study plans.',
        bgImage: '/work-2.png',
    },
    {
        title: 'Discord Bots',
        description: 'Easy to use bots for music, memes and many more.',
        bgImage: '/work-4.png',
    },
]
...
export const toolsData = [
    assets.vscode, assets.mongodb, assets.git, assets.xampp, assets.framer, assets.mysql, assets.androidstudio, assets.github
];